...
directory with this command: python tts.py
https://docs.microsoft.com/fr-fr/azure/cognitive-services/speech-service/quickstart-python-text-to-speech
'''
...
class TextToSpeech(object):
    def __init__(self, subscription_key):
        ...
        self.tts = input("Texte à convertir en français: ")
...
if __name__ == "__main__":
    app = TextToSpeech('216891c9de574dc1b94177cdca749fdc')
    app.get_token()
    app.save_audio()